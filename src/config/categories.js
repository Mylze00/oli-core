...
const CATEGORIES = [
  ...
  { key: 'food',          label: 'Alimentation',  icon: 'restaurant',       image: null },
  { key: 'security',      label: 'Sécurité',      icon: 'security',         image: null },
  { key: 'other',         label: 'Autres',        icon: 'category',         image: null },
];
