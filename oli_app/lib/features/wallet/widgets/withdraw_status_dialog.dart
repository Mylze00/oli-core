...
Future<void> showWithdrawStatusDialog({
  ...
  return showDialog<void>(
    ...
    builder: (_) => WithdrawStatusDialog(
      orderId: orderId,
      amountFC: amountFC,
      ref: ref,
    ),
...
class WithdrawStatusDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<WithdrawStatusDialog> createState() => _WithdrawStatusDialogState();
}
...
class _WithdrawStatusDialogState extends ConsumerState<WithdrawStatusDialog>
  ...
  void _startPolling() {
    // Premier check aprÃ¨s 3 secondes
  ...
  Future<void> _checkStatus() async {
    ...
    try {
      ...
      if (serverStatus == 'success') {
        ...
        try {
          // RafraÃ®chir le solde du wallet
          ...
          debugPrint('Erreur lors des effets de succÃ¨s: $e');
        }
        ...
        // Timeout cÃ´tÃ© client (2 minutes)
        _pollingTimer?.cancel();
        if (mounted) {
          setState(() => _status = DepositStatus.failed);
          _dotController.stop();
      ...
      debugPrint('âš ï¸ Polling status error: $e');
...
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Ã‰tat 1 : EN COURS â€” fond bleu clair + 3 points animÃ©s
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        children: [
          RichText(
            ...
            text: TextSpan(
              ...
              children: [
                const TextSpan(text: 'Votre retrait de\n'),
                TextSpan(
                  text: '$amount FC ',
...
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Ã‰tat 2 : SUCCÃˆS â€” fond bleu clair + âœ… vert animÃ©
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
          ...
          RichText(
            ...
            text: TextSpan(
              ...
              children: [
                ...
                const TextSpan(text: 'a Ã©tÃ© effectuÃ© avec succes'),
              ],
            ),
          ),
          const SizedBox(height: 32),
...
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Ã‰tat 3 : Ã‰CHEC â€” fond rouge clair + âŒ rouge animÃ©
// â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
