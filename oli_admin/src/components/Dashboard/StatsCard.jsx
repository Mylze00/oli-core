...
export default function StatsCard({ title, value, icon, trend, color = 'bg-white', subtitle, link }) {
    ...
    const cardContent = (
        <div className={`${color} p-5 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 ${link ? 'cursor-pointer hover:border-blue-300' : ''}`}>
