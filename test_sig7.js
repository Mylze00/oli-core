...
async function testAll() {
    ...
    // Hash without customer_phone
    let sig1 = `amount500currencyCDFmerchant_idcdef63c4cd8799e3edac01080748d7a3d8a543c6order_idtest-G1`;
    await tryPayload({...payload}, sig1, 'Exclude customer_phone');
